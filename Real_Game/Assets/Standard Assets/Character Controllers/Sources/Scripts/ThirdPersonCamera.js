...
function Awake ()
{
	...
	if(!cameraTransform) {
		print("Please assign a camera to the ThirdPersonCamera script.");
		enabled = false;	
	}
	...
	if (controller)
	{
		...
		print("Please assign a target to the camera that has a ThirdPersonController script attached.");
